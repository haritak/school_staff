class SchoolCoursesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @school_course.save
        ...
        format.json { render :show, status: :created, location: @school_course }
      else
  ...
  def update
    respond_to do |format|
      if @school_course.update(school_course_params)
        ...
        format.json { render :show, status: :ok, location: @school_course }
      else
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to school_courses_url, notice: 'School course was successfully destroyed.' }
  ...
  private
    ...
    def school_course_params
      params.require(:school_course).permit(:school_class_id, :lesson_id, :duration)
    end
end
