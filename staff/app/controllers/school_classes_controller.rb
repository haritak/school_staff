class SchoolClassesController < ApplicationController
  before_action :set_school_class, only: [:show, :edit, :update, :destroy, :duplicate]

  def duplicate
    SchoolClass.create(
      schoolyear: @school_class.schoolyear,
      school: @school_class.school,
      school_grade_specialty_id: @school_class.school_grade_specialty_id,
      number: @school_class.number+1,
