...
class SchoolClassesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create school_class" do
    assert_difference('SchoolClass.count') do
      post school_classes_url, params: { school_class: { capacity: @school_class.capacity, number: @school_class.number, school_grade_specialty_id: @school_class.school_grade_specialty_id, school_id: @school_class.school_id, schoolyear_id: @school_class.schoolyear_id } }
    end
  ...
  test "should update school_class" do
    patch school_class_url(@school_class), params: { school_class: { capacity: @school_class.capacity, number: @school_class.number, school_grade_specialty_id: @school_class.school_grade_specialty_id, school_id: @school_class.school_id, schoolyear_id: @school_class.schoolyear_id } }
