...
class SchoolsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create school" do
    assert_difference('School.count') do
      post schools_url, params: { school: { code: @school.code, email: @school.email, title: @school.title } }
    end
  ...
  test "should update school" do
    patch school_url(@school), params: { school: { code: @school.code, email: @school.email, title: @school.title } }
